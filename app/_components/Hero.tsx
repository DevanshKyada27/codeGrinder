  ...
  return (
    <div className='w-full relative h-screen overflow-hidden'>
        ...
        <div className='absolute w-full flex flex-col items-center mt-24'>
          ...
          <h2 className='font-bold text-8xl font-game text-yellow-400' style={{textShadow: "2px 2px 0 #000, -2px -2px 0 #000, 2px -2px 0 #000, -2px 2px 0 #000"}}>Coding Adventure</h2>
